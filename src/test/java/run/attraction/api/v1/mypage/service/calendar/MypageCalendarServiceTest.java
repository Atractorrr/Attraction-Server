...
public class MypageCalendarServiceTest {
  ...
  void setUp() {
    ...
    readBoxesForTest1 = Arrays.asList(readBox1, readBox2, readBox3);
    readBoxesForTest2 = Arrays.asList(readBox4,readBox5);
  ...
  void getUserCalendar(){
    ...
    assertEquals(userCalendar2.size(),2);
    assertEquals(userCalendar2.get(LocalDate.of(2024,1,1)),2);
  }
}
